...
public class Main2Activity extends AppCompatActivity {
    ...
    TextView text_car;
    Button btn_up_speed, btn_down_speed, btn_move2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                switch (v.getId()) {
                    case R.id.btn_car2:
                        ...
                        if (mycar1.getSpeed() == 100) {
                            ...
                            else if (mycar1.getSpeed() >= 30)
                                meter.setImageResource(R.drawable.middle);
        ...
        btn_move2.setOnClickListener(onClickListener);
